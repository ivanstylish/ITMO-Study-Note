...
class RBFNetwork:
    ...
    # Метод предсказания, код полностью идентичен прямому распространению в обучении: 
    # вычисление матрицы Гаусса RBF, затем умножение на веса и добавление смещения, возврат результата предсказания.

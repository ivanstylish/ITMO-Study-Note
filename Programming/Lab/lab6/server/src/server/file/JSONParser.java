...
public class JSONParser {
    ...
    private static Product parseProduct(String json) throws InvalidInputException {
        try {
            ...
            return product;
        } catch (Exception | WrongLengthException e) {
    ...
    private static Organization parseOrganization(String json) throws InvalidInputException, WrongLengthException {
        Map<String, String> fields = parseJsonObj(json);
        ...
        try {
            ...
            throw new InvalidInputException("The organization's name is too long: " + e.getMessage());
        }
        return org;
    }

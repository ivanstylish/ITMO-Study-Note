...
- [ ] [BasicSoftwareEngineering](ОПИ/readme.md)  
- [ ] [ComputerArchitecture](ComputerArchitecture/readme.md)  
- [x] [MathmaticalStatistics](MathmaticalStatistics/readme.md)  
- [x] [AlgorithmsAndDataStructures](AADS/readme.md)  
- [x] [ComputationalMath](ComputationalMath/readme.md)  
- [x] [Physics](Physics/readme.md)  

## 大三 GRADE 3 (5-6)  
- [ ] [AISystem](AISystem/readme.md)  
- [ ] [OperatingSystem](OperatingSystem/readme.md)  
- [ ] [InformationSystem](InformationSystem/readme.md)  
- [ ] [SoftwareSystemArch](SoftwareSystemArch/readme.md)  
- [ ] [Modeling](Modeling/readme.md)  
- [ ] [KnowledgeGraphs](KnowledgeGraphs/readme.md)  
- [ ] [ComputerGraphicsAlgo](ComputerGraphicsAlgo/readme.md)  
- [ ] [UIDesign](UIDesign/readme.md)  

...
long long fetch_var_value(const map<string, stack<long long>>& var_map, const string& name) {
...
inline void revert_scope(map<string, stack<long long>>& var_map, stack<queue<string>>& level_mods) {

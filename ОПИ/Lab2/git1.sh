...
# r0 — red [branch1]
mkdir -p src; rm -rf src/* 2>/dev/null || true
cp -r rs/r0/* src/ 2>/dev/null || true
git add -A .
git commit -m "Initial commit (r0)"

# r4 — red [branch1]
rm -rf src/*; cp -r rs/r4/* src/ 2>/dev/null || true
git add -A .
git commit -m "Revision 4 (r4)"

# r8 — red [branch1]
rm -rf src/*; cp -r rs/r8/* src/ 2>/dev/null || true
git add -A .
git commit -m "Revision 8 (r8)"

# r10 — red [branch1]
rm -rf src/*; cp -r rs/r10/* src/ 2>/dev/null || true
git add -A .
...
# r1 — blue [branch2]
rm -rf src/*; cp -r rs/r1/* src/ 2>/dev/null || true
git add -A .
...
# branch3：merge from r1
# r2 — red [branch3]
rm -rf src/*; cp -r rs/r2/* src/ 2>/dev/null || true
git add -A .
git commit -m "Revision 2 (r2)"

# r5 — red [branch3]
rm -rf src/*; cp -r rs/r5/* src/ 2>/dev/null || true
git add -A .
git commit -m "Revision 5 (r5)"

# r6 — red [branch3]
rm -rf src/*; cp -r rs/r6/* src/ 2>/dev/null || true
git add -A .
git commit -m "Revision 6 (r6)"

# r7 — red [branch3]
rm -rf src/*; cp -r rs/r7/* src/ 2>/dev/null || true
git add -A .

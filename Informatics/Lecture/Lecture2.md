...
- Коды Блума 绽放代码
    ...
    这些编码能有效纠正二进制数据中的错误，它们结合使用了错误检测器和纠错技术。
- BCH codes BCH码
    BCH-коды - это многоуровневые, циклические, исправляющие ошибки цифровые коды переменной длины, используемые для исправления множества случайных ошибок.
    BCH码是用于校正多个随机错误模式的多级、循环、错误校正、变长数字编码。
